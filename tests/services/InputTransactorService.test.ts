...
import { InputTransactorConfig, TypedData, WalletConfig } from "../../src/models/input-transactor";
...
describe("InputTransactorService", () => {
    ...
    it.only("should return nonce", async () => {
    ...
    it("should assign", async () => {
        ...
        expect(response).toHaveProperty("hexData");
    })
    ...
    it("should send message", async () => {
        ...
        const inputTransactorConfig: InputTransactorConfig = {
            inputTransactorType: "Avail",
            domain: domain,
        }
        const response = await InputTransactorService.sendMessage(walletConfig, inputTransactorConfig, message)
        expect(typeof response).toBe("object");
        expect(response).toHaveProperty("signature");
        expect(response).toHaveProperty("hexData");
    })
